package com.adrija.weather.ui.theme
...
import com.adrija.weather.WeatherViewModel
...
fun WeatherPage(viewModel: WeatherViewModel)
{
    ...
    Column(
        ...
        Row(
            modifier = Modifier.fillMaxWidth().padding(32.dp), verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.SpaceEvenly
        ){
            OutlinedTextField(
                modifier = Modifier.weight(1f),
                value= city,
                onValueChange = { city = it},label={ Text(text = "Search for any Location") }
            )
